...
* ------v------*/
    ...
    addSoundHandlers() {
      document.getElementById("noVNC_sound_button")
          .addEventListener('click', UI.toggleSoundPanel);
      document.getElementById("noVNC_sound_toggle")
 ...
 * ------v------*/
    ...
    openSoundPanel() {
      ...
      document.getElementById('noVNC_sound')
          .classList.add("noVNC_open");
      document.getElementById('noVNC_sound_button')
          .classList.add("noVNC_selected");
    },
    ...
    toggleSoundPanel() {
      if (document.getElementById('noVNC_sound')
          .classList.contains("noVNC_open")) {
          UI.closeSoundPanel();
      } else {
          UI.openSoundPanel();
 ...
 * ------v------*/
    ...
    connect(event, password) {
        ...
        UI.rfb.addEventListener("connect", UI.updateSoundButton);
        UI.rfb.addEventListener("disconnect", UI.updateSoundButton);
